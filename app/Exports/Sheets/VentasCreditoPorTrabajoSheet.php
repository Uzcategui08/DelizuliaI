...
class VentasCreditoPorTrabajoSheet implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithTitle
{
    private $data;
    ...
    public function collection()
    {
        ...
        $ventasCredito = $this->data['ventasPorTrabajo']['credito'] ?? collect();

        foreach ($ventasCredito as $trabajo => $info) {
            $data[] = [
                'trabajo' => $trabajo,
                'monto' => $info['total']
            ];
    ...
    {
        return 'Ventas a Crédito por Trabajo';
    }
