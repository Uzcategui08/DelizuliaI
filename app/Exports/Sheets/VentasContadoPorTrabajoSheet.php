...
class VentasContadoPorTrabajoSheet implements FromCollection, WithHeadings, ShouldAutoSize, WithEvents, WithTitle
{
    private $data;
    ...
    public function collection()
    {
        ...
        $ventasContado = $this->data['ventasPorTrabajo']['contado'] ?? collect();

        foreach ($ventasContado as $trabajo => $info) {
            $data[] = [
                'trabajo' => $trabajo,
                'monto' => $info['total']
            ];
    ...
    {
        return 'Ventas al Contado por Trabajo';
    }
