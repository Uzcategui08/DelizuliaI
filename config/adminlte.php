...
return [
    ...
    */
    ...
    'menu' => [
        ...
        [
            'header' => 'FLOTA',
            'can' => ['admin', 'limited_user'],
        ],
        [
            'text' => 'Camiones (Aceite)',
            'url' => 'camiones/mantenimiento',
            'icon' => 'fas fa-fw fa-truck',
            'can' => ['admin', 'limited_user'],
        ],
        [
            'text' => 'Camiones (Listado)',
            'url' => 'camiones',
